...
public class AppUtils {
     ...
     * @return intent
     */
    public static Intent gettakeCallIntent()
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        Uri data = Uri.parse("tel:" + Constants.OFFICIAL_PHONE);
        intent.setData(data);
        return intent;
    }
    ...
    public static Intent getOpenWebClientIntent(String url)
    {
        ...
        Uri uri = StringUtils.isHttpPic(url) ? Uri.parse(url) : Uri.parse(Cons.URL_DOWNLOAD);
        intent.setData(uri);

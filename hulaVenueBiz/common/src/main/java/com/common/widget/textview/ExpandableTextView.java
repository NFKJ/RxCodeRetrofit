...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mRelayout = false;
        // Setup with optimistic case设置没有超出文本的时按钮高度
        // i.e. Everything fits. No button needed
        mButton.setVisibility(View.INVISIBLE);
        ViewGroup.LayoutParams params= mButton.getLayoutParams();
        params.width= ViewGroup.LayoutParams.MATCH_PARENT;
        params.height= SizeUtils.dp2px(getContext(), 10);
        ...
        ViewGroup.LayoutParams param= mButton.getLayoutParams();
        params.width= ViewGroup.LayoutParams.MATCH_PARENT;
        params.height= ViewGroup.LayoutParams.WRAP_CONTENT;
        mButton.setLayoutParams(param);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.mipmap.icon_more);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.mipmap.icon_less);
        }
        typedArray.recycle();

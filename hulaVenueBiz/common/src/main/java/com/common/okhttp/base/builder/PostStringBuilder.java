package com.common.okhttp.base.builder;

import com.common.okhttp.base.request.PostStringRequest;
...
public class PostStringBuilder extends OkHttpRequestBuilder {
    ...
    @Override
    public PostStringBuilder paramsObj(Map<String, Object> params) {
